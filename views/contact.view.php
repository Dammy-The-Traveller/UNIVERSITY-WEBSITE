<?php include 'partials/head.php' ?>
    ...
    <?php include 'partials/Responsive.Navbar.php'; ?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="pages-image">
                            <img src="/assets/img/pages/pages-9.jpg" alt="pages-image">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="contact-form">
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <textarea class="form-control textarea" placeholder="Your comments..."></textarea>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="contact-information">
                            ...
                            <div class="information-card d-flex align-items-center">
                                <div class="icon">
                                    <i class="ri-phone-line"></i>
                                </div>
                                <div class="content">
                                    <span>Call Us:</span>
                                    <a class="d-block text-decoration-none" href="tel:+233577668812">+233 57 766 8812</a>
                                </div>
                            </div>
                            <div class="information-card d-flex align-items-center">
                                <div class="icon">
                                ...
                                <div class="content">
                                    <span>Mail Us:</span>
                                    <a class="d-block text-decoration-none" href="mailto:ait@ait.edu.gh"><span class="__cf_email__" data-cfemail="97f6fee3d7f6fee3b9f2f3e2b9f0ff">ait@ait.edu.gh</span></a>
                                </div>
                            </div>
                            <div class="information-card d-flex align-items-center">
                                <div class="icon">
                                ...
                                <div class="content">
                                    <span class="d-block">MOpening Hours:</span>
                            ...
                            <div class="information-card d-flex align-items-center">
                                ...
                                <div class="content">
                                    ...
                                    <p>3rd cros, New york ,USA 109002</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="contact-map">
            <div class="container">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d922.8519049853484!2d114.17725747336722!3d22.300418736749894!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x340400ee492bbc0d%3A0x537f183d69286e9e!2sUrban%20Council%20Centenary%20Garden!5e0!3m2!1sen!2sbd!4v1698038945202!5m2!1sen!2sbd"></iframe>
            </div>
        </div>
        <!-- End Contact Map -->
        
        <!-- Start Newsletter Area -->
        <div class="newsletter-area pt-100 pb-75">
            <div class="container">
