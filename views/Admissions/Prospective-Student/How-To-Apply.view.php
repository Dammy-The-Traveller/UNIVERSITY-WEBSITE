...
<?php include __DIR__ . '/../../partials/header.php'; ?>
    ...
    <?php include __DIR__ . '/../../partials/Responsive.Navbar.php'; ?>
      ...
      <div class="pages-banner-area">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="pages-image">
                            <img src="/assets/img/pages/pages-4.jpg" alt="pages-image">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="application-area pt-100 pb-75 apply-pages">
            <div class="container">
                <div class="application-section-title">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-sm-5">
                            <div class="application-btn d-flex justify-content-end">
                                <a class="text-decoration-none default-btn style-2" href="contact.html">
                                    Get Started Now
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6">
                        <div class="single-application-card style-3 apply-pages">
                            ...
                            <div class="content">
                                ...
                                <p>Furthermore, our university camp provide a vibrant & supportive community that embraces diversity.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-application-card style-3 apply-pages">
                            ...
                            <div class="content">
                                ...
                                <p>We believe that a diverse student body enhances learning experience & prepares students to thrive in a globalized world.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="single-application-card style-3 apply-pages">
                            ...
                            <div class="content">
                                ...
                                <p>As student at Ait, you will have access to state-of-the-art facilities, cutting edge research laboratories, & an extensive.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="video-area apply-pages">
            <div class="container">
                <div class="video-image">
                    <img src="/assets/img/video/video-1.jpg" alt="video-image">
                    <div class="video-btn">
